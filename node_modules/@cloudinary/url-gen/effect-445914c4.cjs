...
var GenerativeBackgroundReplace = require('./GenerativeBackgroundReplace-e57ed8dd.cjs');
var Extract = require('./Extract-6569f136.cjs');
...
function trim(colorSimilarity, colorOverride) {
    const trimAction = new TrimAction.TrimAction();
    if (colorSimilarity) {
