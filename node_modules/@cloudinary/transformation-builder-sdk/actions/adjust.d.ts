 ...
 * @namespace Adjust
 */
export declare type IAdjustAction = FillLightAction | RecolorAction | OpacityAdjustAction | By3dLutAction | ImproveAction | ReplaceColorAction | ContrastAction | EffectActionWithLevel | EffectActionWithStrength | EffectActionWithBlend | ViesusCorrectAdjustAction | SimpleEffectAction;
/**
 * @summary action
 ...
 */
declare function contrast(level?: number): ContrastAction;
/**
 * @summary action
 * @memberOf Actions.Adjust
 * @description
